...
from froala_editor.fields import FroalaField #Using FroalaField for writing perfect blogs
...
class Comments(models.Model):
    blog = models.ForeignKey(Blogs,on_delete=models.CASCADE,default=None,blank=True,null=True)
    user = models.ForeignKey(User,on_delete=models.CASCADE,default=None,blank=True,null=True) #for authenticated user's comment
    anonymous_user = models.CharField(max_length=100,null=True,blank=True) #for comment by anonymous user
    person_email = models.EmailField(max_length=100,null=True,blank=True) #for comment by anonymous user
